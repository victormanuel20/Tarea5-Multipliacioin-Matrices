...
Todo el c\'odigo fuente (\texttt{strassen.cpp}, \texttt{brute\_force.cpp},
\texttt{generator.py}, \texttt{graficar.py}), las instancias generadas,
los resultados en CSV y las gr\'aficas se encuentran disponibles en el
repositorio p\'ublico de GitHub:

\begin{center}
\url{https://github.com/victormanuel20/Tarea5-Multipliacioin-Matrices}
\end{center}
